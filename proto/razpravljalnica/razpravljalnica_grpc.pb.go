...
func (c *messageBoardClient) GetSubcscriptionNode(ctx context.Context, in *SubscriptionNodeRequest, opts ...grpc.CallOption) (*SubscriptionNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/razpravljalnica.MessageBoard/GetSubcscriptionNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageBoardClient) SubscribeTopic(ctx context.Context, in *SubscribeTopicRequest, opts ...grpc.CallOption) (MessageBoard_SubscribeTopicClient, error) {
	stream, err := c.cc.NewStream(ctx, &MessageBoard_ServiceDesc.Streams[0], "/razpravljalnica.MessageBoard/SubscribeTopic", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedMessageBoardServer) GetSubcscriptionNode(context.Context, *SubscriptionNodeRequest) (*SubscriptionNodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSubcscriptionNode not implemented")
}
...
func _MessageBoard_GetSubcscriptionNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/razpravljalnica.MessageBoard/GetSubcscriptionNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
